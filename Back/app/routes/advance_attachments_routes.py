...
def upload_attachment_route():
	...
	advance_id = request.form.get("advance_id", type=int)
	attachment_type = request.form.get("attachment_type")

	if advance_id is None:
		raise ValueError("advance_id is required")
...
@advance_attachment_bp.get("/<int:attachment_id>")
@login_required
...
@advance_attachment_bp.get("/<int:attachment_id>/file")
@login_required
